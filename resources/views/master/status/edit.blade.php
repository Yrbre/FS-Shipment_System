...
<nav class="mb-5 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
    ...
    <a href="{{ route('master.statuses.index') }}" class="hover:text-brand-500 transition-colors">Status</a>
    <i class="fa-solid fa-chevron-right text-[10px] text-gray-300 dark:text-gray-600"></i>
    <span class="text-gray-800 dark:text-white font-medium">Edit Status</span>
</nav>
    ...
    <div class="xl:col-span-2">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm">
            ...
            <div class="flex items-center gap-4 border-b border-gray-100 dark:border-gray-800 px-6 py-5">
                ...
                <div>
                    <h3 class="text-base font-semibold text-gray-800 dark:text-white">Edit Status</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Perbarui informasi status di bawah ini</p>
                </div>
            </div>

            {{-- Body Form --}}
            <form action="{{ route('master.statuses.update', $status->id) }}" method="POST" id="myForm">
                @csrf
                @method('PUT')
    ...
    <div class="xl:col-span-1 flex flex-col gap-5">
        ...
        <div class="rounded-2xl border border-blue-100 dark:border-blue-500/20 bg-blue-50 dark:bg-blue-500/10 p-5">
            ...
            <p class="text-xs text-blue-700 dark:text-blue-400 leading-relaxed">
                Status yang diedit akan dapat digunakan saat membuat shipment order.
            </p>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
            ...
            <ul class="space-y-3">
                <li class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Nama Status</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Nama lengkap status. Contoh: <code class="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded">Pending</code></p>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="rounded-2xl border border-amber-100 dark:border-amber-500/20 bg-amber-50 dark:bg-amber-500/10 p-5">
            ...
            <p class="text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
                Kode status tidak dapat diubah setelah digunakan di shipment. Pastikan kode sudah sesuai sebelum menyimpan.
            </p>
        </div>
