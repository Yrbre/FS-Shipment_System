        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <strong class="card-title">Form Create Item</strong>
                </div>
                <div class="card-body">
                    <form method="POST" id="myForm" action="{{ route('master.items.store') }}">
                        @csrf
                        @method('POST')
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12" id="otherUomInput" style="display: none;">
                                ...
                                <input type="text" class="uppercase form-control" id="other_uom" name="other_uom"
                                    placeholder="Enter custom uom" value="{{ old('other_uom') }}">
                            </div>
                            <div class="form-group col-md-12">
