...
<nav class="mb-5 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
    ...
    <a href="{{ route('master.items.index') }}" class="hover:text-brand-500 transition-colors">Item</a>
    <i class="fa-solid fa-chevron-right text-[10px] text-gray-300 dark:text-gray-600"></i>
    <span class="text-gray-800 dark:text-white font-medium">Edit Item</span>
</nav>
    ...
    <div class="xl:col-span-2">
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-sm">
            ...
            <div class="flex items-center gap-4 border-b border-gray-100 dark:border-gray-800 px-6 py-5">
                ...
                <div>
                    <h3 class="text-base font-semibold text-gray-800 dark:text-white">Edit Item</h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Lengkapi informasi item di bawah ini</p>
                </div>
            </div>

            {{-- Body Form --}}
            <form action="{{ route('master.items.update', $item->id) }}" method="POST" id="myForm">
                @csrf
                @method('PUT')
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="Contoh: 1-2-12-0001"
                                maxlength="20"
                                autocomplete="off"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                               <i class="fa-solid fa-weight-scale text-gray-400 dark:text-gray-500 text-sm"></i>
                            </div>
                            <input
                                type="text"
                                id="uom"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                <i class="fa-solid fa-file-pen text-gray-400 dark:text-gray-500 text-sm"></i>
                            </div>
                            <textarea
                                id="description"
                                name="description"
                                placeholder="Contoh: Laptop Dell Inspiron"
                                class="h-11 w-full rounded-xl border border-gray-300 pl-9 pr-4 py-2.5 text-sm text-gray-800 dark:text-white/90 placeholder:text-gray-400 dark:placeholder:text-white/20 dark:bg-gray-900 shadow-theme-xs focus:outline-none focus:ring-3
    ...
    <div class="xl:col-span-1 flex flex-col gap-5">
        ...
        <div class="rounded-2xl border border-blue-100 dark:border-blue-500/20 bg-blue-50 dark:bg-blue-500/10 p-5">
            ...
            <p class="text-xs text-blue-700 dark:text-blue-400 leading-relaxed">
                Item yang diedit akan dapat digunakan saat membuat shipment order.
            </p>
        </div>
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
            ...
            <ul class="space-y-3">
                <li class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Kode Item</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Singkatan unik, huruf kapital. Contoh: <code class="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded">1-2-12-0001</code></p>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-brand-50 dark:bg-brand-500/10 mt-0.5">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Nama Item</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Nama lengkap item. Contoh: <code class="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded">Laptop Dell Inspiron</code></p>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <div class="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-brand-50 dark:bg-brand-500/10 mt-0.5">
                        <span class="text-[10px] font-bold text-brand-500">3</span>
                    </div>
                    <div>
                        <p class="text-xs font-medium text-gray-700 dark:text-gray-300">Satuan</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Satuan pengukuran item. Contoh: <code class="font-mono bg-gray-100 dark:bg-gray-800 px-1 rounded">PCS</code></p>
                    </div>
                </li>
            </ul>
        </div>
        ...
        <div class="rounded-2xl border border-amber-100 dark:border-amber-500/20 bg-amber-50 dark:bg-amber-500/10 p-5">
            ...
            <p class="text-xs text-amber-700 dark:text-amber-400 leading-relaxed">
                Kode item tidak dapat diubah setelah digunakan di shipment. Pastikan kode sudah sesuai sebelum menyimpan.
            </p>
        </div>
