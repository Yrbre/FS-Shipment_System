                        ...
                        <div class="row">
                            @foreach ($permissions as $group => $groupPermissions)
                                @php
                                    ...
                                    $allChecked      = count(array_intersect($groupPermNames, $rolePermissions)) === count($groupPermNames);
                                    ...
                                    <div class="card border h-100" style="border-color: rgba(255,255,255,0.1) !important;">
                                        ...
                                        <div class="card-header d-flex align-items-center justify-content-between py-2 px-3"
                                            ...
                                            <div class="form-check form-switch mb-0 ml-2">
                                                <input class="form-check-input btn-toggle-group"
                                                    type="checkbox"
                                                    data-group="{{ $group }}"
                                                    title="Toggle semua {{ $label }}"
