...
@section('content')
    <div class="flex items-center justify-between p-4 border-b dark:border-gray-700 mb-4">
        ...
        <a href="{{ route('master.departments.create') }}" class="flex items-center gap-1 px-4 py-3 text-sm font-medium text-black transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
